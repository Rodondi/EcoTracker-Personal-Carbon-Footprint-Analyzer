...
def log_activities(transport_km, electricity_kwh, diet, vehicle_model_id=None):
    ...
    # Calculate emissions for transport and electricity
    ...
    # Connect to the local SQLite database and insert activity data
    ...
    # Print summary to the terminal (for debugging or CLI use)
